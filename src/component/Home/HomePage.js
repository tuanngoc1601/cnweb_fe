        ...
        <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col items-start justify-start gap-6">
                ...
                <p className="text-textColor text-lg">
                    ...
                    Qoud ipsam doloribus et similique distinctio, rem deleniti
                    ipsa, nesciunt vitae larbore voluptates sunt ducimus
                    mollitia id libero! Nostrum expedita libero recusandae?
                </p>
                <motion.button className="bg-gradient-to-bl from-orange-400 to-orange-600 px-4 py-2 rounded-xl text-black text-base font-semibold">
                    Order Now
                </motion.button>
            </div>
                    ...
                    {randomData &&
                        randomData.map((data, i) => (
                            <motion.div
                                ...
                                className="w-32 h-36 md:h-auto md:w-190 p-4 backdrop-blur-3xl rounded-3xl flex flex-col items-center justify-center drop-shadow-2xl"
                            >
                                <img
                                    src={data.imageURL}
